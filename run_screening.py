...
def process_batch(universe: pd.DataFrame, yf_client: YFinanceClient, 
    ...
    for idx, row in universe.iterrows():
        ...
        # Fundamentals
        fundamentals = {}
        if category in ("BR_STOCK", "ETF") and fundamentus_data is not None and not fundamentus_data.empty and "ticker" in fundamentus_data.columns:
            ...
            info = yf_client.get_info(analysis_ticker)
            if info:
                fundamentals = {
