...
def is_uptrend(df: pd.DataFrame) -> dict:
    ...
    # Basic conditions
    price_above_sma50 = last["close"] > last.get("sma50", 0)
    price_above_sma150 = last["close"] > last.get("sma150", 0)
    price_above_sma200 = last["close"] > last.get("sma200", 0)
    sma50_above_sma150 = last.get("sma50", 0) > last.get("sma150", 0)
    sma150_above_sma200 = last.get("sma150", 0) > last.get("sma200", 0)
